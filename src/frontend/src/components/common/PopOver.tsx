    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className={`${className} overflow-hidden h-fit absolute bg-white ring-1 ring-gray-200 rounded-md shadow-lg shadow-gray-200 overflow-y-auto [&::-webkit-scrollbar-track]:bg-white  [&::-webkit-scrollbar-track]:rounded-r-3xl [&::-webkit-scrollbar-track]:h-[90%]`}
        >
          {children}
        </motion.div>
      )}
