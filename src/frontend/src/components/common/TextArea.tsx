...
const TextArea= (
  { className, value, placeholder, onChange, onBlur, isDisabled , icon, button, didError, maxLength, maxRows}: TextAreaProps,
) => {
  ...
  return (
    <div 
      className={className +  ` h-fit 
        ...
        (isFocused && !didError ?  "ring-1 ring-green-500 outline outline-offset-1 outline-3 outline-green-100" : '')
      }
    >
      {icon ? (
