        ...
        <AnimatePresence>
          { open &&
            <motion.div 
              ...
              className="w-[16rem] overflow-hidden absolute p-4 flex flex-col z-50 bg-white left-0 top-12 ring-1 ring-gray-200 rounded-md shadow-lg shadow-gray-200"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="w-full h-8 flex items-center justify-between mb-4">
                <div className="flex items-center justify-center gap-2">
                  <div className="rotate-180 w-6 h-6 rounded-md ring-1 ring-gray-200 flex items-center justify-center p-1" onClick={handlePrevYear}>
